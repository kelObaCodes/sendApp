  ...
  return (
    ...
    <div className="header-cover">
        ...
        <div className="header__first_child">
            ...
            <input placeholder="Search" className="header__first_child__input"/>
            <i class="fa fa-search header-search"></i>
            </div>
          
        </div>
        <div className="header__second_child">
          <button className="request-quote-btn mr-20">
              Request Quote
          </button>
          <button className="shipment-btn">
              Book Shipment
          </button>
            <div>

...
<div className="service-box-container">
    <div className={ active === 'air' ? 'active-service' : 'service-box'
}
onClick={()=>
    setActiveDiv('air')
}
>
    ...
    <div className={ active === 'sea' ? 'active-service' : 'service-box'}
    onClick={()=>
        setActiveDiv('sea')
    }
    >
    ...
    <div className={ active === 'inland' ? 'active-service' : 'service-box'
}
onClick={()=>
    setActiveDiv('inland')
}
>
    ...
    <div className={ active === 'customs' ? 'active-service' : 'service-box'
}
onClick={()=>
    setActiveDiv('customs')
}
>
        <div className="service-box_child pd-10">
